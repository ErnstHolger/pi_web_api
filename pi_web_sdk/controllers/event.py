...
class EventFrameController(BaseController):
    ...
    def create_child_event_frame(self, parent_web_id: str, event_frame: Dict) -> Dict:
        """Create a child event frame under a parent event frame."""
        return self.client.post(f"eventframes/{parent_web_id}/eventframes", data=event_frame)
